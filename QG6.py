...
class TextManipulator():
    ...
    def getSentenceList(self, textCorpus):
...
if __name__ == '__main__':
    ...
    ### Actual sentences
    text = "The first Pharaoh of the Old Kingdom was Djoser (sometime between 2691 and 2625 BC) of the third dynasty, who ordered the construction of a pyramid (the Step Pyramid) in Memphis' necropolis, Saqqara."
